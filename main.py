...
class Main(tk.Frame):
    ...
    def update_record(self, name, tel, email, salary):
        self.db.cur.execute("""UPDATE db SET name=?, tel=?, email=?, salary=? WHERE id=?""", (name, tel, email, salary, self.tree.set(self.tree.selection()[0], '#1')))
        self.db.conn.commit()
        self.view_records()
    ...
    def delete_records(self):
        for selection_item in self.tree.selection():
            self.db.cur.execute("""DELETE FROM db WHERE
    ...
    def init_main(self):
        toolbar = tk.Frame(bg='#fff0f5', bd=2)
        ...
        btn_search = tk.Button(toolbar, bg='#d7d8e0', bd=1,
        ...
        btn_refresh = tk.Button(toolbar, bg='#d7d8e0', bd=1,
...
class DB:
    def __init__(self):
        ...
        self.conn = sqlite3.connect("EmployeesList.db")
